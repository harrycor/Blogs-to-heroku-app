...
const PersonalBlogCard = (blogInfo: IBlogsWithAuthors) => {

  //when highlighting it still clicks div change that
  ...
  if (blogInfo.tag !== null) {
    return (
      <div  className="text-black bg-danger text-light mb-5 m-2 card col-xl-2 col-lg-2 col-md-5 col-9">
