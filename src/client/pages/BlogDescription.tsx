  ...
  return (
    <div className="d-flex flex-wrap justify-content-center">
      <div className="d-flex justify-content-center col-12">
        ...
        <div className="d-flex justify-content-evenly mt-2 col-12 flex-wrap">
          <Link to={"/allblogs"} className="btn btn-purps col-md-3 col-11 m-2">
            Back to All Blogs
          </Link>
          <Link to={"/personalblogs"} className="btn btn-purps col-md-3 col-11 m-2">
